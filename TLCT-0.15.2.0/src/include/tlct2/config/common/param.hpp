...
#include "tlct2/config/common/generic.hpp"
...
public:
    ...
    // Constructor
    ParamConfig_() = delete;
    TLCT2_API inline ParamConfig_(const ParamConfig_& rhs) = default;
    TLCT2_API inline ParamConfig_& operator=(const ParamConfig_& rhs) = default;
    TLCT2_API inline ParamConfig_(ParamConfig_&& rhs) noexcept = default;
    TLCT2_API inline ParamConfig_& operator=(ParamConfig_&& rhs) noexcept = default;
    TLCT2_API inline ParamConfig_(GenericParamConfig&& generic_cfg, TSpecificConfig&& spec_cfg,
    ...
    // Initialize from
    [[nodiscard]] TLCT2_API static inline ParamConfig_ fromConfigMap(const ConfigMap& cfg_map);

    // Const methods
    [[nodiscard]] TLCT2_API inline const GenericParamConfig& getGenericCfg() const noexcept { return generic_cfg_; };
    [[nodiscard]] TLCT2_API inline const TSpecificConfig& getSpecificCfg() const noexcept { return spec_cfg_; };
    [[nodiscard]] TLCT2_API inline const TCalibConfig& getCalibCfg() const noexcept { return calib_cfg_; };
