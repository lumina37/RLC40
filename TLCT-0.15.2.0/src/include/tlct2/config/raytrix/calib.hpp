...
public:
    ...
    // Constructor
    TLCT2_API inline CalibConfig() noexcept : diameter_(), rotation_(), offset_(), lofs_(){};
    ...
    TLCT2_API inline CalibConfig(double diameter, double rotation, cv::Point2d offset, LenOffsets lens) noexcept
    ...
    [[nodiscard]] TLCT2_API inline cv::Point2d getOffset() const noexcept { return offset_; };
    [[nodiscard]] TLCT2_API inline LenOffsets getLenOffsets() const noexcept { return lofs_; };
