...
public:
    ...
    // Constructor
    TLCT2_API inline SpecificConfig() noexcept
    ...
    TLCT2_API inline SpecificConfig(const SpecificConfig& rhs) noexcept = default;
    TLCT2_API inline SpecificConfig& operator=(const SpecificConfig& rhs) noexcept = default;
    TLCT2_API inline SpecificConfig(SpecificConfig&& rhs) noexcept = default;
    TLCT2_API inline SpecificConfig& operator=(SpecificConfig&& rhs) noexcept = default;
    TLCT2_API inline SpecificConfig(cv::Size imgsize, int upsample, double psize_inflate, double max_psize,
    ...
    // Initialize from
    [[nodiscard]] TLCT2_API static inline SpecificConfig fromConfigMap(const ConfigMap& cfg_map);
    ...
    [[nodiscard]] TLCT2_API inline double getPsizeInflate() const noexcept { return psize_inflate_; };
    [[nodiscard]] TLCT2_API inline double getMaxPsize() const noexcept { return max_psize_; };
    [[nodiscard]] TLCT2_API inline double getPatternSize() const noexcept { return pattern_size_; };
    [[nodiscard]] TLCT2_API inline int getPsizeShortcutThreshold() const noexcept { return psize_shortcut_threshold_; };
