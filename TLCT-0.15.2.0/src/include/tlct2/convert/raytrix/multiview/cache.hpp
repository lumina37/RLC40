...
#include "tlct2/convert/helper/functional.hpp"
#include "tlct2/convert/raytrix/multiview/params.hpp"
...
public:
    ...
    // Initialize from
    [[nodiscard]] TLCT2_API static inline MvCache fromParams(const MvParams& params);
