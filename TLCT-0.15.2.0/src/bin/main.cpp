...
static inline void render(const tlct2::ConfigMap& cfg_map)
{
...
int main(int argc, char* argv[])
{
    ...
    constexpr std::array<void (*)(const tlct2::ConfigMap&), tlct2::PIPELINE_COUNT> handlers{
        render<tlct2::raytrix::State>,
        render<tlct2::tspc::State>,
    };
